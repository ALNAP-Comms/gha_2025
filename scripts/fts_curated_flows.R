...
fts_curated_flows <- function(years = 2000:2029, update_years = NA, dataset_path = "Datasets/FTS - Full Dataset/Datasets", deflators_path = "datasets/Deflators/deflators_2023USD.csv", base_year = 2023, weo_ver = NULL, dummy_intra_country_flows = T){
  ...
  lapply(c("G:\\My Drive\\Work\\GitHub\\di_script_repo\\gha\\FTS\\fts_get_flows.R", "G:\\My Drive\\Work\\GitHub\\di_script_repo\\gha\\FTS\\fts_split_rows.R", "G:\\My Drive\\Work\\GitHub\\di_script_repo\\general\\get_deflators.R"), source)
